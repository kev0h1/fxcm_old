...
#     field_names = ['Currency','Time', 'Open', 'High', 'Low', 'Close', 'Sentiment', 'Net Buy', 'Net Sell', 'S3', 'S2',
#                   'S1', 'P', 'R1', 'R2', 'R3', 'Entry_Point', 'Stop_loss', 'Take_Profit', 'Buy/Sell', 'Win/Loss']
...
def write_to_csv(currency, time, _open, high, low, close, sentiment, net_buy,
                net_sell, s3, s2, s1, p, r1, r2, r3, entry, stop, limit, order_type, 
                 win_loss
                )
...
eurusd
data_dictionary ={}
data_dictionary[10009] = {"Currency":"EUR/USD", "Entry_Point":-1,"S3": eurusd['S3'],"S2":eurusd['S2'],"S1":eurusd['S1'], 
                              "Pivot":eurusd['P'], "R1":eurusd['R1'], "R2":eurusd['R2'], "R3":eurusd['R3']}
