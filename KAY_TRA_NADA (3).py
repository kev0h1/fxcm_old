...
def pivot_with_sentiment_signal(curr, df, _close, pivot_nm):  
    ...
    if (p2f(sentiment_table[sentiment_table_name]['Net Long'])<(p2f(sentiment_table[sentiment_table_name]['Net Short']) and sentiment_table[sentiment_table_name]['Sentiment']=="MIXED") or sentiment_table[sentiment_table_name]['Sentiment']=="BULLISH":
